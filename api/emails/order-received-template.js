...
export default function(order) {
    const shippingDetails = order.updatedShippingAddress || order.stripeSession.shipping_details;
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <br>${ shippingDetails.address.city }, ${ shippingDetails.address.state } ${ shippingDetails.address.zipCode }
    </span>
    </div>
    </div>
